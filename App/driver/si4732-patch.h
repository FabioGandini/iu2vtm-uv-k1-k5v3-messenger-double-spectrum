/* SSB patch content for the Si4732-A10 / Si4735-D60, compressed format.
 *
 * Derived from patch_ssb_compressed.h of the PU2CLR SI4735 Arduino library
 * (MIT license, https://github.com/pu2clr/SI4735). The patch itself was
 * published by Vadim Afonkin on his Dropbox repository; it is firmware for
 * the SSBRX function of the Si47xx DSP and is NOT covered by the firmware
 * license of this project.
 *
 * Compression scheme (see SI4735::downloadCompressedPatch): the original
 * patch is a sequence of 8-byte records whose first byte is either 0x15 or
 * 0x16. Here each record is stored as its 7 payload bytes; cmd_0x15[] lists
 * the record indexes whose command byte is 0x15, every other record uses
 * 0x16.
 *
 * Include this header from si473x.c only.
 */

#ifndef DRIVER_SI4732_PATCH_H
#define DRIVER_SI4732_PATCH_H

#include <stdint.h>

static const uint16_t cmd_0x15[] = {
