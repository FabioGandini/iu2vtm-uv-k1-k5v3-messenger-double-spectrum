...
- A modified CHIRP driver (`chirp/iu2vtm.chirp.v5.5.0.messenger.py`, based on the F4HWN driver) exposing the messenger settings, including the encryption password.
